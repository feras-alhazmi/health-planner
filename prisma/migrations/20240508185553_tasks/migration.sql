...
-- AddForeignKey
ALTER TABLE "TaskEditor" ADD CONSTRAINT "TaskEditor_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("Id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PlanEditor" ADD CONSTRAINT "PlanEditor_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("Id") ON DELETE RESTRICT ON UPDATE CASCADE;
