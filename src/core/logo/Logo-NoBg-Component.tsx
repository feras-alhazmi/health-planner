...
export default function LogoNoBg({ size = 50 }: { size?: number }) {
  return (
    <div className={`size-${size}`}>
      ...
      >
        ...
        <g transform="matrix(0.6666666666666666,0,0,0.6666666666666666,249.39393939393932,550.0815571057368)">
          <svg
            viewBox="0 0 396 158"
          ...
          >
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,0.24000000000003752,0.23189124739195677)"
            >
              <svg
                viewBox="0 0 395.5199999999999 157.5362175052161"
                height="157.5362175052161"
              ...
              >
                <g>
                  <svg
                    ...
                    width="395.5199999999999"
                  >
                    <g transform="matrix(1,0,0,1,0,104.37874237880932)">
                      <svg
                        viewBox="0 0 395.5199999999999 53.15747512640678"
                        height="53.15747512640678"
                        width="395.5199999999999"
                      >
                    ...
                    <g transform="matrix(1,0,0,1,161.06640718017354,0)">
                      <svg
                        viewBox="0 0 73.38718563965287 91.82953828086771"
                        height="91.82953828086771"
                        width="73.38718563965287"
                      >
                        <g>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            x="0"
                            y="0"
                            viewBox="11.600000000000001 2.4 76.80000000000001 96.1"
                          ...
                          >
                            <path
                              d="M88.3 29.9l-0.1-0.4c-0.2-0.6-0.5-1.1-0.9-1.5L63.2 3.6c-0.3-0.3-0.6-0.5-1-0.7l-1.3-0.4L22.8 2.4c-6.2 0-11.2 5-11.2 11.2v73.7c0 6.2 5 11.2 11.2 11.2h54.4c6.2 0 11.2-5 11.2-11.2V30.9L88.3 29.9zM63.4 15.3l12.6 12.8h-9.4c-1.7 0-3.1-1.4-3.1-3.1V15.3zM45.7 40.9h-6.6v6.6c0 1.4-1.2 2.6-2.6 2.6-1.4 0-2.6-1.2-2.6-2.6v-6.6h-6.6c-1.4 0-2.6-1.2-2.6-2.6s1.2-2.6 2.6-2.6h6.6v-6.6c0-1.4 1.2-2.6 2.6-2.6 1.4 0 2.6 1.2 2.6 2.6v6.6h6.6c1.4 0 2.6 1.2 2.6 2.6S47.1 40.9 45.7 40.9zM77.6 86H62.3v-3.7h15.2V86zM77.6 76.3H49.2v-3.7h28.4V76.3zM77.6 66.9H49.2v-3.7h28.4V66.9z"
                              fill="#FEFEFE"
                              data-fill-palette-color="accent"
                            ></path>
                          </svg>
