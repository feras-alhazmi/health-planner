...
const Sidebar: React.FC = () => {
  return (
    <div className="w-full bg-blue text-white-300 pt-[100px] h-full flex flex-col">
      ...
      <ul className="m mt-32 text-white w-full">
        <li
          className="flex items-center w-full px-10 py-3 border-r-white border-l-[4px]"
          style={{
            background:
